...
getQuantowerKeybdBtnToggleState()    {
    ...
    if (!init)    {
        ...
        if (!fileExist(pathOff:=A_Temp "\quantower-keybd-btn-off.png"))
            download("https://raw.githubusercontent.com/SevenKeyboard/get-quantower-keybd-btn-toggle-state/refs/heads/main-ahkv2.0/quantower-keybd-btn-off.png", pathOff)
        if (!fileExist(pathOn:=A_Temp "\quantower-keybd-btn-on.png"))
            download("https://raw.githubusercontent.com/SevenKeyboard/get-quantower-keybd-btn-toggle-state/refs/heads/main-ahkv2.0/quantower-keybd-btn-on.png", pathOn)
